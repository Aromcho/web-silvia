...
export default function PropertyDetail({ property }) {
  ...
  useEffect(() => {
    ...
    const updateSidebarState = () => {
      ...
      const activationPoint = sidebarTopRef.current - 104
      setIsSidebarFixed(window.scrollY >= activationPoint)
    }
  ...
  return (
    <div className="property-detail-page">
      ...
      <div className="property-title-section">
        <div className='direction-price'>
          ...
          <div className="property-badges">
            <div
              className={`price ${isRentalOperation ? "price-consult" : ""}`}
            > 
      ...
      <div className="container property-detail-container">
        ...
        <div
          ref={sidebarRef}
          className={`sidebar-column ${isSidebarFixed ? 'is-fixed' : ''}`}
        >
